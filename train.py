...
from solver_ml_selfsup import Solver


# training settings
parser = argparse.ArgumentParser(description='Training for SSG')
...
def main():
    ...
    solver = Solver(args, target=args.target, learning_rate=args.lr, interval = intervals, batch_size=args.batch_size,
